...
const selectedReviewHandler = (number:number) =>{
    ...
    return <div className={styles.container}>
        <H2About h2='Opinie klientów' about='Sprawdź co o moich usługach mówią klienci.'/>
        <div className={styles.reviewsContainer}>
            <div className={styles.reviewsBox}>
                <button onClick={prevReviewHandler} className={styles.chevronButton}><img src={BackIcon.src} alt='back icon'/></button>
                <img className={styles.reviewImg} src={REVIEWS_ARRAY[reviewNumber].src}/>
                <button onClick={nextReviewHandler} className={styles.chevronButton}><img src={ForwardIcon.src} alt='forward icon'/></button>
            </div>
