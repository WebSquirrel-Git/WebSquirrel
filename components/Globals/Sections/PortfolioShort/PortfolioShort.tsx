...
import PortfolioShortCard, { PortfolioShortCardProps } from '@/components/Ui/Cards/PortfolioShortCard/PortfolioShortCard'
...
portfolio_url:"/portfolio"
     ...
     {
header:"Brandbook",
website_url:"https://www.behance.net/gallery/226380319/ATZM-Design-Brandbook",
...
const PortfolioShort = () =>{
    ...
    return <div className={styles.container}>
        <H2About h2='Przykładowe realizacje' about='Sprawdź co udało mi się stworzyć w ramach współpracy z klientami. Każdy projekt był indywidualnie dostosowany pod zleceniodawcę i powstał w wyniku naszej wspólnej pracy i zaangażowania.'/>
    <div className={styles.rowBox}>
        {PORTFOLIO_SHORT_ITEMS.map((project,index)=><PortfolioShortCard {...project} key={index}/>)}
        
    </div>
    <div className={styles.linkBox}>
        <p>Przycisk poniżej przeniesie Cię na stronę mojego portfolio gdzie znajdziesz więcej realizacji.</p>
