...
import OfferWebsiteCard, { OfferWebsiteCardPropsType } from '@/components/Ui/Cards/OfferWebsiteCard/OfferWebsiteCard'
...
const OFFER_SINGLE_PAGE:OfferWebsiteCardPropsType=
    {
       ...
       mainList:['Cała treść na jednej stronie','Przedstawienie informacji o firmie w widocznych sekcjach z nagłówkami','Poprawki tekstów podanych przez zlecającego pod SEO','Dopasowane ikony'],
...
const OFFER_STANDARD_PAGE:OfferWebsiteCardPropsType=
    {
       ...
       mainList:['Strona główna','Do 5 podstron','Indywidualny projekt graficzny dla każdej podstrony','Propozycje tekstów','Pływające menu nawigacyjne','Dopasowane ikony'],
       wordpressList:['Łatwy w obsłudze panel do zarządzania treścią strony'],
       nextJsList:[]
    }
const OFFER_PREMIUM_PAGE:OfferWebsiteCardPropsType=
    {
       ...
       mainList:['Strona główna','Do 10 podstron','Indywidualny projekt graficzny dla każdej podstrony','Propozycje tekstów','Pływające menu nawigacyjne','Dopasowane ikony','Animacje','Rozbudowana stopka'],
       wordpressList:['Łatwy w obsłudze panel do zarządzania treścią strony'],
       nextJsList:[{
        type:'check',
...
const OFFER_CREATIVE_PAGE:OfferWebsiteCardPropsType=
    {
       ...
       {
        type:'check',
        value:'Możliwość stworzenia własnych systemów opartych na kodzie TS niezależnych od firm trzecich'
       },
       {
        type:'check',
        value:'Wysoka wydajność'
...
<H2About h2='Ile kosztuje strona www?' about='Wszystkie podane ceny są orientacyjne. Proces tworzenia stron i sklepów internetowych jest indywidualny i zależy od potrzeb oraz zakresu prac – dlatego ostateczna wycena może się różnić. W celu poznania dokładnego kosztu Twojej realizacji projektu skontaktuj się.'/>
