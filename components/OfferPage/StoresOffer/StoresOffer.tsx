...
const StoresOffer = () => {
  return (
    <div className={styles.container}>
      ...
      <p className={styles.info}>
        Jeżeli chcesz dowiedzieć się więcej o korzyściach jakie przynosi sklep
        internetowy i czy jest to odpowiednie rozwiązanie dla Ciebie sprawdź mój
        artykuł klikając{' '}
        <Link
          href="/artykuly/korzysci-plynace-z-posiadania-sklepu-internetowego"
