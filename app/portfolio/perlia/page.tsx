...
import HeroImg from '@/public/portfolio/perlia/pc.png'
...
const CONTENT = {
  ...
  about:{
    text1:'Perlia to marka zajmująca się tworzeniem ręcznie robionej biżuterii z kamieni naturalnych. Założycielką jest Weronika, której głównym kanałem sprzedaży jest jej konto prowadzone na Instagramie.',
    text2:'Ze względu na nowe pomysły założycielki oraz zainteresowanie jej rękodziełem oferta biżuterii ulegała stałemu powiększaniu. Instagram zapewnia bardzo dobre możliwości promocji nowych produktów lecz wraz z rozwojem oferty zaczął pojawiać się problem z przedstawieniem wszystkich dostępnych produktów dla klientów. Kolejnym istotnym problemem była specyfika platformy, która ograniczała szczegółowe opisy produktów i zwiększała ilość pytań o produkty.',
    logo:Logo,
    alt:'Perlia'
  },
  targets:['Stworzenie strony, która będzie odpowiednio prezentować markę','Stworzenie sklepu, który będzie pełnił rolę katalogu produktów z widocznym podziałem na kategorie i łatwością przeglądania przez klienta','Wybranie platformy, która będzie łatwa w obsłudze i umożliwiała zarządzanie produktami oraz informacjami o marce','Umożliwienie zakupu produktu z dostawą przez sklep'],
results:['Umożliwienie zakupu produktu z dostawą przez sklep','Klienci regularnie odwiedzają stronę w celu sprawdzenia nowości','Mniejsza ilość zapytań o szczegóły produktów','Właścicielka po przeszkoleniu sama edytuje treści, zarządza stanami magazynowymi, kuponami oraz edycją i dodawaniem nowych produktów'],
...
export default function PortfolioPerlia() {
  ...
  <Gallery galleryLandscapes={CONTENT.galleryLandscapes} galleryPortraits={CONTENT.galleryPortraits} alt='Perlia strona internetowa'/>
